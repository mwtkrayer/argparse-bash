...
argparse_add_flag(){
  ...
  _argparse_assert "[[ '$1' =~ ^[a-zA-Z]+\$ ]]" "[argparse_add_flag] expecting <name> as 1st argument: must contain letters only. (got $1)" 
...
argparse_add_optional(){
  ...
  _argparse_assert "[[ '$1' =~ ^[a-zA-Z]+\$ ]]" "[argparse_add_optional] expecting <name> as 1st argument: must contain letters only. (got $1)" 
...
argparse_add_mandatory(){
  ...
  _argparse_assert "[[ '$1' =~ ^[a-zA-Z]+\$ ]]" "[argparse_add_mandatory] expecting <name> as 1st argument: must contain letters only. (got $1)" 
...
argparse_add_positional(){
  ...
  _argparse_assert "[[ '$1' =~ ^[a-zA-Z]+\$ ]]" "[argparse_add_positional] expecting <name> as 1st argument: must contain letters only. (got $1)" 
  _argparse_verify_state
...
argparse_eval(){
  ...
  for _input in ${_argp_all_args[*]}; do
    ...
    elif [[ "${_input}" =~ ^--[a-zA-Z]+$ ]]; then # name mode
      for (( ii=0; ii<${narg}; ii++ )); do
